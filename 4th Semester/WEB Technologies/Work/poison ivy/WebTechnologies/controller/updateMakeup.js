...
function getUpdateJS(req, res) {
    ...
    var data2 = fs.readFileSync('./views/scripts/update.js', 'utf8');
...
module.exports = { getUpdateMakeupHTML, getUpdateMakeupCSS1, getUpdateMakeupCSS2, getUpdateMakeupJS, getUpdateJS }