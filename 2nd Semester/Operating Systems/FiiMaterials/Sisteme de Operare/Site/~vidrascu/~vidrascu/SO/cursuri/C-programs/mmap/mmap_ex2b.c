...
int main(int argc, char *argv[])
{
    ...
    map_addr = mmap( NULL,                   // Se va crea o mapare începând de la o adresă page-aligned aleasă de kernel (și returnată în map_addr)
                     ...
                     PROT_WRITE,             // Tipul de protecție a mapării: paginile mapării vor permite accese doar în scriere
                                             // Notă: pe arhitectura x86, dreptul de scriere implică și drept de citire a paginii !!!
